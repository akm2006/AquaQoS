...
| [`docs/AI_PROVENANCE.md`](docs/AI_PROVENANCE.md), `docs/prompts/` | AI attribution and sanitized planning evidence, retained for ETHOnline transparency; not runtime dependencies |
