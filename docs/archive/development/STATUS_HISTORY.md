...
The owner-approved `docs/product/DESIGN_SYSTEM.md` now locks the supplied `AquaQoS.svg` as the final logo and
defines the blue-led marketing / calm application split. `docs/product/APP_ARCHITECTURE.md` records
