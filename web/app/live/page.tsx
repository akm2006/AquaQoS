...
import { num, short } from "../evidence";
import "./live.css";
              ...
              >
                ...
                <details>
                  ...
                  <p className="source-line">
                    Vault → Aqua allowance: {t.allowance}
                  </p>
                </details>
              </section>
            ))}
                ...
                <div>
                  <strong>
                    {quote.error
                      ...
                      : `${num(quote.input!)} Token ${1 - quote.token} → ${num(quote.amount)} Token ${quote.token}`}
                  </strong>
                  <p>
                    {quote.error
